...
export class ChiTietSanPhamTiepNhanComponent implements OnInit {
  ...
  dataShow(): void {
    const tooltipFormatter = (row: any, cell: any, value: string) => `<div title="${value}">${value}</div>`;
